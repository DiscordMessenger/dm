...
private:
	...
	FormattedText* m_pRepliedMessage = nullptr;
...
public:
	...
	MessageItem(const MessageItem& other) { // copy
		...
		if (other.m_pRepliedMessage)
			m_pRepliedMessage = new FormattedText(*other.m_pRepliedMessage);
	...
	MessageItem(MessageItem&& other) noexcept { // move
		...
		m_pRepliedMessage = other.m_pRepliedMessage; other.m_pRepliedMessage = nullptr;
